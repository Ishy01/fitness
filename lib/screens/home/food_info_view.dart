...
import 'package:fitness/common_widgets/food_step_detail_row.dart';
                    ...
                    children: [
                              ...
                              return Container(
                                  ...
                                  decoration: BoxDecoration(
                                      gradient: LinearGradient(
                                        colors: [
                                          TextColor.primaryColor2.withOpacity(0.4),
                                          TextColor.primaryColor1.withOpacity(0.4)
                                        ],
                                      ),
                                      borderRadius: BorderRadius.circular(10)),
                                  child: Row(
                      ...
                      Padding(
                        ...
                        child: ReadMoreText(
                          ...
                          trimLines: 4,
                          colorClickableText: TextColor.black,
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        nObj["title"].toString(),
                                        style: TextStyle(
                                            color: TextColor.black, fontSize: 12),
                                      ),
                                      Text(
                                        nObj["value"].toString(),
                                        style: TextStyle(
                                            color: TextColor.gray, fontSize: 10),
                                      ),
                                    ],
                                  ));
                            }),
