...
import 'package:fitness/common_widgets/find_eat_well.dart';
import 'package:fitness/common_widgets/rounded_button.dart';
import 'package:fitness/common_widgets/today_meal_row.dart';
import 'package:fitness/screens/home/meal_food_details.dart';
import 'package:fitness/screens/home/meal_schedule.dart';
              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                            gradient: LinearGradient(colors: TextColor.primaryGradient),
                              ...
                              items: ["Weekly", "Monthly"]
                                  .map((name) => DropdownMenuItem(
                                        ...
                                        child: Text(
                                          name,
                                          style: TextStyle(
                                              color: TextColor.gray, fontSize: 14),
                                        ),
                                      ))
                                  .toList(),
                              onChanged: (value) {},
                              icon:
                                  Icon(Icons.expand_more, color: TextColor.white),
                              hint: Text(
                                "Weekly",
                                textAlign: TextAlign.center,
                                style: TextStyle(
                                    color: TextColor.white, fontSize: 12),
                              ),
                            ),
                          )),
                    ],
                        ...
                        LineChartData(
                                ...
                                return TouchedSpotIndicatorData(
                                  ...
                                  FlDotData(
                                    ...
                                    getDotPainter:
                                      ...
                                      color: Colors.white,
                                      strokeWidth: 3,
                                      strokeColor: TextColor.secondaryColor1,
                                    ),
                                  ),
                                );
                              }).toList();
                          ...
                          gridData: FlGridData(
                            ...
                            getDrawingHorizontalLine: (value) {
                              return FlLine(
                                color: TextColor.gray.withOpacity(0.15),
                                strokeWidth: 2,
                              );
                            },
                          ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: TextColor.primaryColor2.withOpacity(0.3),
                      borderRadius: BorderRadius.circular(15),
                    ),
                    child: Row(
                      mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  LineChartBarData get lineChartBarData1_1 => LineChartBarData(
        ...
        dotData: FlDotData(
          ...
          getDotPainter: (spot, percent, barData, index) => FlDotCirclePainter(
            ...
            color: Colors.white,
            strokeWidth: 1,
            strokeColor: TextColor.primaryColor2,
          ),
        ),
