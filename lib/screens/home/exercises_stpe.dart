...
import 'package:fitness/common_widgets/step_detail_row.dart';
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              Stack(
                ...
                children: [
                  ...
                  Container(
                    ...
                    height: media.width * 0.43,
                    decoration: BoxDecoration(
                        color: TextColor.black.withOpacity(0.2),
                        borderRadius: BorderRadius.circular(20)),
                  ),
                  IconButton(
                    onPressed: () {},
              ...
              SizedBox(
                ...
                child: CupertinoPicker.builder(
                  ...
                  selectionOverlay: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border(
                        top: BorderSide(color: TextColor.gray.withOpacity(0.2), width: 1),
                        bottom: BorderSide(
                            color: TextColor.gray.withOpacity(0.2), width: 1),
                      ),
                    ),
                  ),
              ...
              RoundedButton(title: "Save", elevation: 0, onPressed: () {}),
              const SizedBox(
                height: 15,
              ),
            ],
