...
import 'package:fitness/common_widgets/exercises_set_section.dart';
import 'package:fitness/common_widgets/rounded_button.dart';
import 'package:fitness/screens/home/exercises_stpe.dart';
import 'package:fitness/screens/home/workout_schedule_view.dart';
...
class _WorkoutDetailViewState extends State<WorkoutDetailView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration:
          BoxDecoration(gradient: LinearGradient(colors: TextColor.primaryGradient)),
              ...
              children: [
                  ...
                  child: Column(
                    children: [
                      ...
                      Container(
                        ...
                        height: 4,
                        decoration: BoxDecoration(
                            color: TextColor.gray.withOpacity(0.3),
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  ...
                                  style: TextStyle(
                                      color: TextColor.gray, fontSize: 12),
                                ),
                              ],
                            ),
                          ),
                      ...
                      IconTitleNextRow(
                          ...
                          title: "Difficulity",
                          time: "Beginner",
                          color: TextColor.secondaryColor2.withOpacity(0.3),
                          onPressed: () {}),
                      SizedBox(
                        height: media.width * 0.05,
                      ),
                        ...
                        children: [
                          ...
                          TextButton(
                            ...
                            child: Text(
                              "${youArr.length} Items",
                              style:
                                  TextStyle(color: TextColor.gray, fontSize: 12),
                            ),
                          )
                        ],
                      ),
                ...
                SafeArea(
                  child: Column(
                    ...
                    children: [
                      RoundedButton(title: "Start Workout", onPressed: () {})
                    ],
                  ),
                )
              ],
